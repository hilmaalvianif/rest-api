...
function getmhs() {
    $mahasiswa = [
        ["npm" => "187006077", "mahasiswa" => "mahasiswa ini mahasiswa ke-1"],
        ["npm" => "187006074", "mahasiswa" => "mahasiswa ini mahasiswa ke-2"],
        ["npm" => "187006018", "mahasiswa" => "mahasiswa ini mahasiswa ke-3"]
    ];
    return $mahasiswa;
}
